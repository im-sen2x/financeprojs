"""-Version 1.1 of duration1.py
Helper functions were utilized"""
...
for column_name in dr1.columns:
	...
	cash_flow = dfunc.get_cashflows(num_semesters, bd_facevalue, bd_couponrate, bd_periods, "Cash_Flows")
